...
namespace BeroInc.CBeroEditors
{
    ...
    /// </summary>
    [Guid(GuidList.guidCBeroEditorsEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private CBeroEditorsPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(CBeroEditorsPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidCBeroEditorsEditorFactory;
            pgrfCDW = 0;
