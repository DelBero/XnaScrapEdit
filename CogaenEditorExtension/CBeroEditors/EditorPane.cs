...
namespace BeroInc.CBeroEditors
{
    ...
    //     - An empty cbero file in the same directory as NewFileItems.vsdir. In
    //       our case we chose CBeroConfig.cbero. Note this file name appears in Editor.vsdir
    ...
    //          - "CBeroConfig" - This is the base file name. New files will initially
    //             be named as CBeroConfig1.cbero, CBeroConfig2.cbero... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    CBeroConfig.cbero|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - CBeroConfig.cbero - our empty cbero file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".cbero";
        ...
        #region Fields
        private CBeroEditorsPackage myPackage;
        ...
        public EditorPane(CBeroEditorsPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the cbero document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(CBeroEditorsPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidCBeroEditorsCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidCBeroEditorsCmdSet, PkgCmdIDList.IDMX_RTF);
