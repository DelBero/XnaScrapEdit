...
using CogaenEditExtension.Helper;

namespace CogaenEditExtension.Communication
{
    public partial class MessageHandler : IDisposable
    {
        public void connectCallback(String s, byte type, uint id, object data)
        {
        ...
        public void deleteGameObjectCallback(String asw, byte type, uint id, object data)
        {

        }

        #region data updates
        public void updateSubsystemDataCallbackRest(String s, byte type, uint id, object data)
        {
        ...
        public void updateServiceDataCallbackRest(String s, byte type, uint id, object data)
        {
                ...
                foreach (XmlNode node in services)
                {
                    if (node.Name == "Service")
                    {
                        ...
                        foreach (XmlAttribute attr in node.Attributes)
                        {
                            ...
                            {
                                guid = Guid.Parse(attr.Value);
                            }
                        }
                        subsystem.Services.Add(new Service(name, sId, guid));
                    }
                }
            }
        }
        ...
        public void updateParameterDataCallbackRest(String s, byte type, uint id, object data)
        {
        ...
        public void updateMacroDataCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        public void updateLiveDataCallbackRest(String asw, byte type, uint id, object data)
        {
            XmlNodeList gameobjects = getRestData(asw);
            if (Data.LiveGameObjects == null)
            {
                Data.LiveGameObjects = new ObjectBuilder("LiveGameObjects", Data);
            }
            else
        ...
        public void runScriptOnceCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        public void runScriptOnceCallbackRestCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        public void runScriptOnceCallbackRestCallbackRestCallbackRest(String asw, byte type, uint id, object data)
        {
            // ok enough with the callbacks
        }

        public void registerScriptCallbackRest(String asw, byte type, uint id, object data)
        {

        }

        public void runScriptCallbackRest(String name, byte type, uint id, object data)
        {

        }

        public void registerMacroCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        public void runMacroCallbackRest(String asw, byte type, uint id, object data)
        {

        }

        public void sendMessageCallbackRest(String name, byte type, uint id, object data)
        {
        ...
        #region resources
        public void updateResourcesCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        public void updateResourceFolderCallbackRest(String asw, byte type, uint id, object data)
        {
        ...
        private void getResourceCallbackRest(String asw, byte type, uint id, object data)
        {
