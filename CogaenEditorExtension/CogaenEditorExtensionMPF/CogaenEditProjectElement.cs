...
namespace CogaenEditExtension
{
    ...
    /// </summary>
    public sealed class CogaenEditProjectElement
    {
        #region fields
        private MSBuild.ProjectItem item;
        private CogaenEditProject itemProject;
        ...
        public static bool operator ==(CogaenEditProjectElement element1, CogaenEditProjectElement element2)
        {
            ...
            string include1 = null;// element1.GetMetadata(ProjectFileConstants.Include);
            string include2 = null;// element2.GetMetadata(ProjectFileConstants.Include);
        ...
        {
            CogaenEditProjectElement element2 = obj as CogaenEditProjectElement;
            if(element2 == null)
                return false;
