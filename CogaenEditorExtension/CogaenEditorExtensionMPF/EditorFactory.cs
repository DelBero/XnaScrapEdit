...
namespace CogaenEditExtension
{
    ...
    /// </summary>
    [Guid(GuidList.guidCogaenEditExtensionEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private CogaenEditExtensionPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(CogaenEditExtensionPackage package)
        {
