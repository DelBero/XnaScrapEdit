...
namespace CogaenEditExtension
{
    ...
    public class XnaContentReferenceContainerNode : HierarchyNode , IReferenceContainer
    {
        #region fields
        internal const string ReferencesNodeVirtualName = "ContentReferences";
        #endregion

        #region ctor
        public XnaContentReferenceContainerNode(ProjectNode root)
            : base(root)
        {
        ...
        private static string[] supportedReferenceTypes = new string[] {
            CogaenEditProjectConstants.ContentReference
        };
        ...
        public override string Caption
        {
            get
            {
                return "Content";//SR.GetString(SR.ReferencesNodeName, CultureInfo.CurrentUICulture);
            }
        }


        //private Microsoft.VisualStudio.Project.Automation.OAReferences references;
        ...
        //        if (null == references)
        //        {
        //            references = new Microsoft.VisualStudio.Project.Automation.OAReferences(this);
        //        }
        //        return references;
        //    }
        //}
        ...
        //    return new Microsoft.VisualStudio.Project.Automation.OAReferenceFolderItem(this.ProjectMgr.GetAutomationObject() as Microsoft.VisualStudio.Project.Automation.OAProject, this);
        //}
        ...
        protected override int QueryStatusOnNode(Guid cmdGroup, uint cmd, IntPtr pCmdText, ref QueryStatusResult result)
        {
            ...
            else if (cmdGroup == GuidList.guidCogaenEditExtensionCmdSet)
            {
        ...
        protected override int ExecCommandOnNode(Guid cmdGroup, uint cmd, uint nCmdexecopt, IntPtr pvaIn, IntPtr pvaOut)
        {
            if (cmdGroup == GuidList.guidCogaenEditExtensionCmdSet)
            {
                switch (cmd)
                {
                    case PkgCmdIDList.cmdidAddContentRef:
                        {
                            if (this.ProjectMgr is CogaenEditProject)
                            {
                                return (ProjectMgr as CogaenEditProject).AddContentReference();
                            }
                            break;
                        }
                }
        ...
        {
            ReferenceNode node = null;
            if (referenceType == CogaenEditProjectConstants.ContentReference)
            {
                node = this.CreateXnaContentReferenceNode(element);
            }
        ...
        protected virtual ReferenceNode CreateReferenceNode(VSCOMPONENTSELECTORDATA selectorData, string wrapperTool = null)
        {
            ...
            switch (selectorData.type)
            {
                case VSCOMPONENTTYPE.VSCOMPONENTTYPE_Project:
                    node = this.CreateContentReferenceNode(selectorData);
                    break;
        ...
        protected virtual XnaContentReferenceNode CreateXnaContentReferenceNode(ProjectElement element)
        {
            return new XnaContentReferenceNode(this.ProjectMgr, element);
        }

        /// <summary>
        /// Create a Project to Project reference given a VSCOMPONENTSELECTORDATA structure
        /// </summary>
        protected virtual XnaContentReferenceNode CreateContentReferenceNode(VSCOMPONENTSELECTORDATA selectorData)
        {
            return new XnaContentReferenceNode(this.ProjectMgr, selectorData.bstrTitle, selectorData.bstrFile, selectorData.bstrProjRef);
        }
