...
namespace CogaenEditExtension
{
    public partial class MyEditor : UserControl
    {
        ...
        public MyEditor()
        {
            ...
            m_Recorder = new VSMacroRecorder(GuidList.guidCogaenEditExtensionEditorFactory);
        }
        ...
        public ObjectBuilderControl ObjectBuilderControl
        {
            get
            {
                return objectBuilderControl1;
            }
        }
